...
- An Telegram Bot By [@DarkPheonix](https://t.me/DarkPhew) To Stream Videos in Telegram Voice Chat.
...
- `SESSION_STRING` : Generate From here [![GenerateStringName](https://img.shields.io/badge/repl.it-generateStringName-yellowgreen)](https://replit.com/@ErichDaniken/Generate-Telegram-String-Session)
...
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/Bottesterheroku/vcVideoPlayer">
...
```sh
$ git clone https://github.com/Bottesterheroku/vcVideoPlayer.git
$ cd vcVideoPlayer
