...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data=="help":
        buttons = [
            [
                InlineKeyboardButton("🗣️ Feedback", url="https://t.me/DarkPhewPMBot"),
                InlineKeyboardButton("Channel 📢", url="https://t.me/DynamicCourses"),
            ],
            [
                InlineKeyboardButton("🔰 Source Code 🔰", url="https://github.com/Itz-Ayanokoji"),
            ],
            [
...
async def help(client, message):
    buttons = [
            [
                InlineKeyboardButton("🗣️ Feedback", url="https://t.me/DarkPhewPMBot"),
                InlineKeyboardButton("Channel 📢", url="https://t.me/DynamiCourses"),
            ],
            [
                InlineKeyboardButton("🔰 Source Code 🔰", url="https://github.com/Itz-Ayanokoji
            [
